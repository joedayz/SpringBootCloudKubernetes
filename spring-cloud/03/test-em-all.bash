...
ACCESS_TOKEN=$(curl -X POST https://dev-imn0x68y.us.auth0.com/oauth/token \
-d grant_type=client_credentials \
-d audience=https://localhost:8443/product-composite \
-d scope=product:read+product:write \
-d client_id=OBv31qN7jw9c4gCPDzz6rA1t1e5LNyZP \
-d client_secret=u_nB0P0OreYHDWuhNzi4fZm-lCzyS_XynImdghFcw3lOdabZeZFauh5QWD-gEXYw -s | jq -r .access_token)
...
READER_ACCESS_TOKEN=$(curl -X POST https://dev-imn0x68y.us.auth0.com/oauth/token \
-d grant_type=client_credentials \
-d audience=https://localhost:8443/product-composite \
-d scope=product:read \
-d client_id=h6hxhdRZwsOXnc7Wn7wF1JFme0j1Hacf \
-d client_secret=M4XCLLkjGZfKBy6tJEfh4nH0Umq35DV9MlT925Kz1KFchT0NEBxsOCL1G-6lK2QG -s | jq -r .access_token)
